...
export const REJECTION_PATTERNS: RejectionPattern[] = [
    ...
    },
    {
        ...
        fix: 'Review regional obligations with counsel, then use Apple-supported tools where applicable: Declared Age Range for age category and regulatory signals, PermissionKit Significant Update actions for parent or guardian permission, StoreKit age rating properties, and App Store Server Notifications including consent revocation. Build with Xcode 26.2 and the iOS/iPadOS 26.2 SDK or later for the full regional age-assurance framework set; iOS/iPadOS 26.4 adds required-regulatory-feature and significant-update acknowledgement APIs. New Apple Accounts are subject to state-specific age-assurance handling in Utah as of May 6, 2026, Texas as of June 4, 2026, and Louisiana as of July 1, 2026. Test age ranges, location restrictions, approval states, and consent revocation in sandbox where supported. Keep App Store Connect age-rating answers and App Review notes aligned with the implemented age-assurance behavior.',
    },
] as const;
