...
export const REJECTION_PATTERNS: RejectionPattern[] = [
    ...
    },
    {
        ...
        trigger: 'App is distributed in Texas, Brazil, Australia, Singapore, Utah, or Louisiana and includes age-sensitive social, UGC, 18+, Apple In-App Purchase, or significant-update flows without using available age-assurance signals or documenting how parent or guardian consent and revocation are handled where required',
        fix: 'Review regional obligations with counsel, then use Apple-supported tools where applicable: Declared Age Range for age category and regulatory signals, PermissionKit Significant Update actions for parent or guardian permission, StoreKit age rating properties, and App Store Server Notifications including consent revocation. New Apple Accounts are subject to state-specific age-assurance handling in Utah as of May 6, 2026, Texas as of June 4, 2026, and Louisiana as of July 1, 2026. Keep App Store Connect age-rating answers and App Review notes aligned with the implemented age-assurance behavior.',
    },
] as const;
