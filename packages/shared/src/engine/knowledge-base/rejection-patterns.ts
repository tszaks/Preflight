...
export const REJECTION_PATTERNS: RejectionPattern[] = [
    ...
    },
    {
        ...
        fix: 'Use exact pixel dimensions accepted by App Store Connect. Current primary examples: 6.9" iPhone (1320x2868, 1260x2736, or 1290x2796), 6.5" iPhone (1284x2778 or 1242x2688), 6.3"/6.1" iPhone (1206x2622, 1179x2556, 1170x2532, or 1080x2340), and 13" iPad (2064x2752 or 2048x2732).',
    },
