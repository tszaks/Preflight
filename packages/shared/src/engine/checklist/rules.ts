...
export const SELF_REPORT_RULES: SelfReportRule[] = [
    ...
    {
        id: 'sr_display_advertising_compliance',
        tier: 2,
        category: 'content_policy',
        severity: 'warning',
        title: 'Display advertising must comply with guideline 2.5.18',
        description: 'App displays ads. Under 2.5.18, ads must be limited to the main app binary (not extensions, App Clips, widgets, keyboards, watchOS). Interstitial ads must have visible close buttons. App must include ability for users to report ads. No behavioral/targeted ads based on health, medical, school, or kids data.',
        guideline_ref: '2.5.18 — Display Advertising',
        fix_suggestion: 'Ensure all ads are only in the main app binary. Add visible close/skip buttons to interstitial ads. Include an ad reporting mechanism. Do not use health, medical, school, or children\'s data for ad targeting.',
        source: 'Apple Guideline 2.5.18',
        trigger_field: 'has_display_ads',
        trigger_value: true,
        confirm_field: 'ads_compliant_2518',
        pass_value: true,
    },
    {
        id: 'sr_recording_logging_consent',
        tier: 2,
        category: 'content_policy',
        severity: 'critical',
        title: 'Recording or logging requires explicit consent and visual indicator',
        description: 'App records camera, microphone, screen, or user inputs (including analytics SDKs that capture screen recordings). Guideline 2.5.14 requires explicit user consent and a clear visual/audible indication during recording.',
        guideline_ref: '2.5.14 — Recording and Logging',
        fix_suggestion: 'Request explicit user consent before any recording or screen capture. Display a clear visual indicator (such as a recording dot) whenever recording is active. This applies to analytics tools like Glassbox, FullStory, or similar screen recording SDKs.',
        source: 'Apple Guideline 2.5.14 + developer forum rejection reports',
        trigger_field: 'has_recording_features',
        trigger_value: true,
        confirm_field: 'recording_consent_implemented',
        pass_value: true,
    },
    {
        id: 'sr_anonymous_chat_prohibition',
        tier: 2,
        category: 'content_policy',
        severity: 'critical',
        title: 'Anonymous or random chat functionality prohibited',
        description: 'App provides random or anonymous chat features (stranger matching, anonymous messaging, Chatroulette-style). As of February 6, 2026, Apple explicitly prohibits these under guideline 1.2 and apps may be removed without notice.',
        guideline_ref: '1.2 — User-Generated Content',
        fix_suggestion: 'Remove anonymous/random chat features entirely. If chat is essential, require verified identity and implement full content moderation (filtering, reporting, blocking). Anonymous chat apps are no longer permitted on the App Store.',
        source: 'Apple App Review Guidelines update February 6, 2026 + 9to5Mac coverage',
        trigger_field: 'has_anonymous_chat',
        trigger_value: true,
        pass_value: false,
    },
    {
...
export const INFORMATIONAL_RULES: ChecklistRule[] = [
    ...
    },
    {
        ...
        description: 'Apple expanded age ratings to new tiers (4+, 9+, 13+, 16+, 18+) with region-specific ratings in July 2025. The deadline to complete the updated questionnaire was January 31, 2026. Apps that have not completed it CANNOT submit updates.',
        guideline_ref: '2.3 — Accurate Metadata (Age Rating)',
        fix_suggestion: 'Log into App Store Connect immediately and complete the updated Age Rating Questionnaire. If you missed the January 31, 2026 deadline, you must complete it before you can submit any app updates.',
        source: 'Apple July 2025 age rating expansion + January 31, 2026 deadline (passed)',
    },
    {
        ...
        category: 'content_policy',
        severity: 'info',
        title: 'Upcoming SDK minimum: Xcode 26 + iOS 26 SDK',
        description: 'Starting April 28, 2026, all new app submissions and updates must be built with Xcode 26 or later and the iOS 26 SDK. Apple rebranded versioning to align with the calendar year.',
        guideline_ref: '2.5 — Software Requirements',
        fix_suggestion: 'Update your development environment to Xcode 26+ and build against the iOS 26 SDK before the April 28, 2026 deadline.',
        source: 'Apple developer.apple.com/news/ — SDK submission requirements February 3, 2026',
    },
    {
