...
export const VALID_SCREENSHOT_DIMENSIONS: Array<{ width: number; height: number; device: string }> = [
    ...
    // Older iPhone displays still listed by App Store Connect
    ...
    { width: 1640, height: 2360, device: '11" iPad' },
    // Older iPad displays still listed by App Store Connect
    { width: 1668, height: 2224, device: '10.5" iPad' },
    { width: 1536, height: 2008, device: '9.7" iPad (without status bar)' },
    { width: 1536, height: 2048, device: '9.7" iPad' },
    { width: 768, height: 1004, device: '9.7" iPad (without status bar)' },
    { width: 768, height: 1024, device: '9.7" iPad' },
    ...
    { width: 1096, height: 640, device: '4" iPhone (landscape without status bar)' },
    ...
    { width: 2360, height: 1640, device: '11" iPad (landscape)' },
    { width: 2224, height: 1668, device: '10.5" iPad (landscape)' },
    { width: 2008, height: 1536, device: '9.7" iPad (landscape without status bar)' },
    { width: 2048, height: 1536, device: '9.7" iPad (landscape)' },
    { width: 1004, height: 768, device: '9.7" iPad (landscape without status bar)' },
    { width: 1024, height: 768, device: '9.7" iPad (landscape)' },
];
