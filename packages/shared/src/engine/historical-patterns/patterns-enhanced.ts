...
export const ENHANCED_PATTERNS: EnhancedRejectionPattern[] = [
    ...
    },
    {
        ...
        trigger: 'Apps with age-sensitive social, UGC, 18+, or significant-update flows may need region-specific age assurance in Texas, Brazil, Australia, Singapore, Utah, or Louisiana',
        ...
        match: {
            ...
            keywords: ['texas', 'brazil', 'australia', 'singapore', 'utah', 'louisiana', '18+', 'age assurance', 'declared age range', 'significant update', 'parental consent'],
            features_required: ['has_ugc'],
            min_matches: 2,
            base_confidence: 50,
        },
