            ...
            if (screenshot.width && screenshot.height) {
                ...
                if (!validDim) {
                    results.push({
                        ...
                        confidence: 100,
                        guideline_ref: getGuidelineRef('2.3.7'),
                        fix_suggestion: `Use an App Store Connect accepted size such as 1320x2868, 1290x2796, or 1260x2736 (6.9"), 1284x2778 or 1242x2688 (6.5"), 1206x2622, 1179x2556, 1170x2532, 1125x2436, or 1080x2340 (6.3"/6.1"), 1242x2208, 750x1334, 640x1136, or 640x960 (legacy iPhone), 2064x2752 or 2048x2732 (13" iPad), 1488x2266 / 1668x2420 / 1668x2388 / 1640x2360 (11" iPad), or 1668x2224 / 1536x2048 / 768x1024 (legacy iPad).`,
                    });
                }
            }
        }
