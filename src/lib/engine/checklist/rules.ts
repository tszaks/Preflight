...
export const DESCRIPTION_RULES: ChecklistRule[] = [
    {
        ...
        source: 'Apple Guideline 2.1 + Reddit rejection reports',
    },
    {
    ...
    },
    {
        ...
        source: 'Apple November 2024 guidelines update + developer reports',
    },
];
...
export const SELF_REPORT_RULES: SelfReportRule[] = [
    // === Content & Features ===
    {
        ...
        source: 'Apple Guideline 1.2 — #3 most common rejection reason',
    ...
    },
    {
        ...
        source: 'Apple November 2024 guidelines update on generative AI',
    ...
    // === Monetization ===
    {
        ...
        description: 'App has subscriptions but does not confirm that price, duration, renewal terms, and cancellation instructions are displayed on the paywall screen.',
        guideline_ref: '3.1.2 — Subscriptions',
        fix_suggestion: 'Display full subscription terms on the paywall: price, billing period, auto-renewal notice, and how to cancel.',
        source: 'Apple Guideline 3.1.2 — #1 monetization rejection reason',
    ...
    // === Technical ===
    {
        ...
        guideline_ref: '2.3.1 — Accurate Screenshots',
        ...
        source: 'Apple Guideline 2.3.1 — top metadata rejection reason',
    ...
    },
    {
        ...
        guideline_ref: '2.1 — Performance: App Completeness',
        ...
        source: 'Apple Technical Note TN3151 + developer forum reports',
    ...
    },
    {
        ...
        description: 'App requests camera, location, or tracking permissions at launch instead of when the feature is first used.',
        guideline_ref: '5.1.1(ii) — Permission',
        fix_suggestion: 'Request permissions only when the user initiates a feature that requires them. Never ask on first launch.',
        source: 'Apple Guideline 5.1.1(ii) + common rejection reports',
    ...
    // === Authentication (reuses existing field) ===
    {
        ...
        fix_suggestion: 'Add Sign in with Apple as a login option alongside any third-party login providers.',
        source: 'Apple Guideline 4.8 — mandatory since iOS 13, heavily enforced',
...
export const INFORMATIONAL_RULES: ChecklistRule[] = [
    {
        ...
        source: 'Apple Guideline 4.0 — "bait-and-switch" is a permanent ban risk',
    },
    {
