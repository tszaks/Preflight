    ...
    <div class="auth-container">
        <div class="auth-header">
            ...
            {#if isFromPricing && selectedPlan}
                <p class="context-msg">
                    Sign up to purchase the <strong>{planNames[selectedPlan] || selectedPlan}</strong> plan
                </p>
            {:else}
                <p class="subtitle">Start catching App Store issues before Apple does</p>
            {/if}
        </div>
                ...
                use:enhance={() => {
                    ...
                    return async ({ result }) => {
                        ...
                        if (result.type === "failure") {
                            ...
                            success = (result.data?.message as string) ?? "Check your email to confirm.";
                        }
                    };
                }}
                class="auth-form"
        ...
        <p class="auth-switch">
            Already have an account? <a href="/auth/login{nextUrl ? `?next=${nextUrl}` : ''}{selectedPlan ? `&plan=${selectedPlan}` : ''}">Log in</a>
        </p>
    </div>
</main>
